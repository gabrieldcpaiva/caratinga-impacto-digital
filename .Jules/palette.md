...
## 2024-10-24 - Vestibular Accessibility in JS Scrolling
**Learning:** Hardcoding `behavior: 'smooth'` in JS `scrollIntoView` calls overrides user OS preferences for reduced motion, potentially causing discomfort for users with vestibular disorders.
