...
## 2024-06-25 - Explicit Focus Indicators for Keyboard Navigation
**Learning:** Custom UI components across both 'The Void Principle' and 'Golden Mold' themes lacked explicit `:focus-visible` styles, hindering keyboard navigation for accessibility without disrupting mouse/touch users.
