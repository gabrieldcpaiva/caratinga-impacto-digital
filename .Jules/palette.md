...
## 2024-06-26 - Respect Vestibular Accessibility Settings
**Learning:** Hardcoded smooth scrolling behaviors (e.g., `scrollIntoView({ behavior: 'smooth' })`) can cause motion sickness for users with vestibular disorders.
