...
## 2024-06-17 - Missing Focus Visible Styles
**Learning:** Custom UI components lacked explicit `*:focus-visible` styles, which hindered keyboard navigation accessibility for users relying on tabs without disrupting mouse/touch users.
