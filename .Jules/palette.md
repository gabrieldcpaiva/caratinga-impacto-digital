...
## 2024-06-21 - Keyboard Accessibility via Focus Visible
**Learning:** Custom UI components across the project lack explicit focus states for keyboard navigation, and relying on `:focus` can disrupt mouse/touch users.
