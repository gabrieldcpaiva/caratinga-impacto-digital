...
## 2024-05-17 - Keyboard Navigation and Focus Styles
**Learning:** Custom UI components lacked explicit `*:focus-visible` styles, making keyboard navigation difficult without disrupting mouse/touch users.
